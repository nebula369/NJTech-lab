...
public class ActivityService {
    ...
    public Activity getByPkId(Integer pkId)
    {
        try
        {
    ...
    public int insert(Activity website)
    {
        try {
    ...
    public int update(Activity website)
    {
        try {
    ...
    {
        try {
            Activity website = getByPkId(pkId);
            if(website!=null) {
    ...
    public List<Activity> getActivityListForPage(String searchStr, String orderStr)
    {
        try {
