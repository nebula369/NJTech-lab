                ...
                <div class="col-xs-12">
                    <form class="form-horizontal" id="validation-form" role="form">
                        <div class="form-group" id="stage">
                            <label class="control-label col-sm-3 no-padding-right text-right" style="float:left;padding-top: 5px;width: 100px;" for="stage">值日内容:</label>
                            <div class="col-sm-9" style="float: left; margin-top: 5px;">
                                <div class="clearfix" style="float:left;">
                                    <textarea  class="form-control" value="" id="content" name="content"   cols="40"   rows="4"   style="overflow: hidden; margin: 0px; width: 300px; height: 95px;resize: none;">${cleanhealth.content}</textarea>
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript">
    jQuery(function ($) {
        ...
        $("#validation-form .btn-success").on("click", function () {
            ...
            jQuery.ajax({
                type: "POST",
                data: {"pkid":${cleanhealth.pkid},"content":$("#content").val()},
                dataType: "text",
                url: "/manage/eclassbrand/cleanhealth/doEdit",
        ...
        $("#validation-form .btn-danger").on("click", function () {
            ...
            jQuery.ajax({
                type: "POST",
                data: {"id":${cleanhealth.pkid}},
                dataType: "text",
                url: "/manage/eclassbrand/cleanhealth/doDel",
                success: function (result) {
                    if(result == 1) {
