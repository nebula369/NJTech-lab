                                    ...
                                    <div class="form-group" id="stage">
                                        ...
                                        <div class="col-sm-9" style="float: left; margin-top: 5px;">
                                            <div class="clearfix" style="float:left;;width:200px">
                                                <input class="form-control" value="${activitydetail.describe}" id="title" name="title" type="text">
                                            </div>
                                        </div>
                                    </div>
                                </td>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9" style="float: left; margin-top: 5px;">
                                            <div class="clearfix" style="float:left;">
                                                <img src="/${activitydetail.photo}"  id="pictureimg" alt="头像"  height="60px"  onerror="javascript:this.src='/assets/lib/images/default/defaultpicture.png';">
                                                <input type="file" id="file" name="file"  />
                                                <input type="hidden" id="picture" name="picture"  value="${activitydetail.photo}" />
                                            </div>
                                        </div>
                                    </div>
                                </td>
...
<script type="text/javascript">
    jQuery(function ($) {
        ...
        $("#validation-form .btn-success").on("click", function () {
            ...
            jQuery.ajax({
                type: "POST",
                data: {"pkid":${activitydetail.pkid},"describe":$("#title").val(),"photo":$("#picture").val()},
                dataType: "text",
                url: "/manage/eclassbrand/activity/DetaildoEdit",
