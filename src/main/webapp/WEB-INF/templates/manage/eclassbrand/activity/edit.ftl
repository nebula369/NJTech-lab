                                    ...
                                    <div class="col-xs-12 col-sm-9" style="float:left;width: 400px;margin-top: 5px;">
                                        <div style="float: left;margin-right: 5px;">
                                            <label class="line-height-1">
                                                <input name="type" id="type" <#if activity.activitytype==1>checked</#if>  value="1" type="radio" class="ace">
                                                <span class="lbl" onclick="$('#chooseclass').hide();$('#txtType').val('1');">学校活动</span>
                                            </label>
                                        </div>
                                        <div style="float: left;margin-right: 5px;">
                                            <label class="line-height-1">
                                                <input name="type" id="type" <#if activity.activitytype==0>checked</#if> value="0" type="radio" class="ace">
                                                <span class="lbl" onclick="$('#chooseclass').show();$('#txtType').val('0');">班级活动</span>
                                            </label>
                                        </div>
                                        <input type="text" style="display: none;" id="txtType" value="${activity.activitytype}">
                                    </div>
                                </div>
                            </td>
                            <td>
                                <div class="form-group" id="chooseclass" <#if activity.activitytype==1>style="display:none"</#if> >
...
<#--                                                <#list classList as item>
                                                    <option value="${item.pkid}" <#if item.pkid == classid>selected</#if>>${item.name}</option>
                                                </#list>-->
                                            </select>
                                        </div>
                                    </div>
                        ...
                        <tr>
                                ...
                                <div class="form-group" id="stage">
                                    ...
                                    <div class="col-sm-9" style="float: left; margin-top: 5px;">
                                        <div class="clearfix" style="float:left;;width:200px">
                                            <input class="form-control" value="${activity.title}" id="title" name="title" type="text">
                                        </div>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <div class="form-group" id="stage">
                                    ...
                                    <div class="col-sm-9" style="float: left; margin-top: 5px;">
                                        <div class="clearfix" style="float:left;;width:200px">
                                            <input class="form-control" value="${activity.author}" id="author" name="author" type="text">
                                        </div>
                                    </div>
                                </div>
                            </td>
                        ...
                        <tr>
                            <td>
                                <div class="form-group" id="stage">
                                    ...
                                    <div class="col-sm-9" style="float: left; margin-top: 5px;">
                                        <div class="clearfix" style="float:left;;width:200px">
                                            <input class="form-control" value="${activity.intro}" id="intro" name="intro" type="text">
                                        </div>
                                    </div>
                                </div>
                            </td>
                        ...
                        <tr>
                            <td>
                                <div class="form-group" id="stage">
                                    ...
                                    <div class="col-sm-9" style="float: left; margin-top: 5px;">
                                        <div class="clearfix" style="float:left;width:200px">
                                            <input class="form-control" value="${activity.sortnum}" id="sortnum" name="sortnum" type="text">
                                        </div>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9" style="float: left; margin-top: 5px;">
                                        <div class="clearfix" style="float:left;">
                                            <img src="/${activity.photo}"  id="pictureimg" alt="头像" width="80px" height="80px"   onerror="javascript:this.src='/assets/lib/images/avatars/avatar2.png';">
                                            <input type="file" id="file" name="file"  />
                                            <input type="hidden" id="picture" name="picture" value="${activity.photo}" />
                                        </div>
                                    </div>
                                </div>
                            </td>
                        ...
                        <input type="hidden" id="time1" value="${starttime}">
                        <input type="hidden" id="time2" value="${endtime}">
...
<script type="text/javascript">
    jQuery(function ($) {
        ...
        $("#validation-form .btn-success").on("click", function () {
            ...
            jQuery.ajax({
                type: "POST",
                data: {"pkid":${activity.pkid},"activityType":$('#txtType').val(),"classid":$("#classid").val().toString(),"intro":$("#intro").val(),"title":$("#title").val(),"author":$("#author").val(),"starttime":$("#searchDate").val().split('至')[0],"endtime":$("#searchDate").val().split('至')[1],"sortnum":$("#sortnum").val(),"content":"","photo":$("#picture").val()},
                dataType: "text",
                url: "/manage/eclassbrand/activity/doEdit",
        ...
        function initClassIdList()
        {
            jQuery.ajax({
                ...
                // data: {"unitId":unitId},
                dataType: "json",
                url: "/manage/eclassbrand/activity/getSchoolClassList",
                success: function (result) {
                    var html = '';
