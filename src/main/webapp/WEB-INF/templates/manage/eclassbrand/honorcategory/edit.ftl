                ...
                <div class="col-xs-12">
                    <form class="form-horizontal" id="validation-form" role="form">
                                ...
                                <div class="clearfix" style="float:left;">
                                    <select class="chosen-select form-control" disabled="disabled" name="classid" id="classid" style="width: 300px;" data-placeholder="--请选择班级--">
                                        ...
                                        <#list classList as item>
                                            <option value="${item.pkid}" <#if item.pkid == honorcategory.classid>selected</#if>>${item.name}</option>
                                        </#list>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="form-group" id="stage">
                            ...
                            <div class="col-sm-9" style="float: left; margin-top: 5px;">
                                <div class="clearfix" style="float:left;">
                                    <input class="form-control" style="width: 300px;"  id="name" name="name" value="${honorcategory.name}" type="text">
                                </div>
                            </div>
                        </div>
                        <div class="form-group" id="stage">
                            ...
                            <div class="col-sm-9" style="float: left; margin-top: 5px;">
                                <div class="clearfix" style="float:left;">
                                    <input class="form-control" value="1" style="width: 300px;" id="sortnum" name="sortnum" value="${honorcategory.sortnum}" type="text">
                                </div>
                            </div>
                        </div>
    ...
    jQuery(function ($) {
        ...
        $("#validation-form .btn-success").on("click", function () {
            ...
            var obj = $(this);
             jQuery.ajax({
                type: "POST",
                data: {"pkid":${honorcategory.pkid},"name":$("#name").val(),"sortnum":$("#sortnum").val(),"classid":$("#classid").val()},
                dataType: "text",
                url: "/manage/eclassbrand/honorcategory/doEdit",
