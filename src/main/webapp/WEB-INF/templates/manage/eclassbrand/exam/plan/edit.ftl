                        ...
                        <table style="width: 100%">
                            <tr>
                                ...
                                <td>
                                    <div class="form-group" id="stage">
                                        ...
                                        <div class="col-sm-9" style="float: left; margin-top: 5px;">
                                            <div class="clearfix" style="float:left;">
                                                <input class="form-control" value="${examplan.subject}"  id="subject" name="subject" type="text"  >
                                            </div>
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <div class="form-group" id="stage">
                                        ...
                                        <div class="col-sm-9" style="float: left; margin-top: 5px;">
                                            <div class="clearfix" style="float:left;">
                                                <input class="form-control" value="${examplan.grade}"  id="grade" name="grade" type="text" style="width: 255px;height:34px;">
                                            </div>
                                        </div>
                                    </div></td>
                                <td>   <div class="form-group" id="stage">
                                        ...
                                        <div class="col-sm-9" style="float: left; margin-top: 5px;">
                                            <div class="clearfix" style="float:left;">
                                                <input class="form-control" value="${examplan.examiner}" id="examiner" name="examiner" type="text">
                                            </div>
                                        </div>
                                    </div></td>
                            </tr>
                            <tr>
                                <td>  <div class="form-group" id="stage">
                                        ...
                                        <div class="col-sm-9" style="float: left; margin-top: 5px;">
                                            <div class="clearfix" style="float:left;">
                                                <input class="form-control" value="${examplan.ticket}"  id="ticket" name="ticket" type="text" style="width: 255px;height:34px;">
                                            </div>
                                        </div>
                                    </div></td>
                                <td>       <div class="form-group" id="stage">
                                        ...
                                        <div class="col-sm-9" style="float: left; margin-top: 5px;">
                                            <div class="clearfix" style="float:left;">
                                                <input class="form-control" value="${examplan.sortnum}"   id="sortnum" name="sortnum" type="text">
                                            </div>
                                        </div>
                                    </div></td>
                            </tr>
...
<script type="text/javascript">
    jQuery(function ($) {
        ...
        $("#validation-form .btn-success").on("click", function () {
            ...
            jQuery.ajax({
                type: "POST",
                data: {"pkid":${examplan.pkid},"subject":$("#subject").val(),"grade":$("#grade").val(),"examiner":$("#examiner").val(),"ticket":$("#ticket").val(),"sortnum":$("#sortnum").val(),"startDate":$("#searchDate").val().split('至')[0]+":00","endDate":$("#searchDate").val().split('至')[1]+":00"},
                dataType: "text",
                url: "/manage/eclassbrand/examplan/doEdit",
