...
<div class="main-container ace-save-state" id="main-container">
    ...
    <!-- 加载左侧菜单 -->
    <@leftMenu indexUrl="/manage/eclassbrand/index" menuList=menuConfig.menuList currentUrl="/manage/eclassbrand/website"/>
                ...
                <div class="row">
                    <div class="col-xs-12" style="padding:0px;">
                        <div style="margin-bottom: 5px;">
                            <button id="btnAdd" style="float:left; margin-top: 5px" class="btn btn-success btn-mini radius-4" value=""><i class="ace-icon fa fa-plus"></i>新增网站地址</button>
                            ...
                            <label style="padding-top: 5px;" class="col-sm-1 no-padding-right" for="year">网站名称</label>
                            <input type="text" id="searchKey" style="width: 250px;" placeholder="请输入网站名称" class="input-sm" />
...
<script type="text/javascript">
    jQuery(function ($) {
        ...
        $("#grid-table").jqGrid({
            ...
            colModel: [
                ...
                {name: 'url', index: 'url', align: 'left',sortable:false, resize:false},
        ...
        $("#btnAdd").on("click", function () {
            layer_show("新建网站地址", "/manage/eclassbrand/website/add", 600, 350);
    ...
    function modify(id)
    {
        layer_show("编辑网站地址", "/manage/eclassbrand/website/edit?id=" + id, 600, 350);
        event.stopPropagation();
    }
    ...
    {
        layer.confirm("确定删除网站地址“"+name+"”？", function (index) {
            layer.close(index);
            jQuery.ajax({
                type: "POST",
                data: {"id":id},
                dataType: "text",
                url: "/manage/eclassbrand/website/doDel",
