                ...
                <div class="col-xs-12">
                    <form class="form-horizontal" id="validation-form" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9" style="float: left; margin-top: 5px;">
                                <div class="clearfix" style="float:left;">
                                    <select class="chosen-select form-control tag-input-style" disabled="disabled" name="subject" id="subject" style="width: 300px;" data-placeholder="--请选择学科--">
                                        <option value=""></option>
                                        <#list subjectList as item>
                                            <option value="${item.code}" <#if item.code == task.subject>selected</#if>>${item.name}</option>
                                        </#list>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-xs-12 col-sm-9" style="float:left;width: 400px;margin-top: 5px;">
                                <div style="float: left;margin-right: 5px;">
                                    <label class="line-height-1">
                                        <input name="type" id="type"  <#if task.type==1>checked</#if> value="1" type="radio" class="ace">
                                        <span class="lbl">家庭作业</span>
                                    </label>
                                </div>
                                <div style="float: left;margin-right: 5px;">
                                    <label class="line-height-1">
                                        <input name="type" id="type"  <#if task.type==2>checked</#if>  value="2" type="radio" class="ace">
                        ...
                        <div class="form-group" id="stage">
                            ...
                            <div class="col-sm-9" style="float: left; margin-top: 5px;">
                                <div class="clearfix" style="float:left;">
                                     <textarea  class="form-control" value="" id="content" name="content"   cols="40"   rows="4"   style="overflow: hidden; margin: 0px; width: 300px; height: 95px;resize: none;">${task.content} </textarea>
                                </div>
                            </div>
                        </div>
                        <div class="form-group" id="stage">
                            ...
                            <div class="col-sm-9" style="float: left; margin-top: 5px;">
                                <div class="clearfix" style="float:left;">
                                    <input class="form-control" value="${task.sortnum}" id="sortnum" name="sortnum" type="text">
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript">
    jQuery(function ($) {
        ...
        $("#validation-form .btn-success").on("click", function () {
            ...
            jQuery.ajax({
                type: "POST",
                data: {"pkid":${task.pkid},"content":$("#content").val(),"type":type,"sortnum":$("#sortnum").val(),"classid":classid,"subject":subject},
                dataType: "text",
                url: "/manage/eclassbrand/task/doEdit",
       ...
       initClassIdList();
        function initClassIdList()
        {
            jQuery.ajax({
               ...
               // data: {"unitId":unitId},
                dataType: "json",
                 url: "/manage/eclassbrand/task/getSchoolClassList",
                success: function (result) {
                    var html = '';
