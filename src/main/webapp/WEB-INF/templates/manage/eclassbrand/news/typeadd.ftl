                            ...
                            <div class="col-xs-12 col-sm-9" style="float:left;width: 300px;margin-top: 5px;">
                                <div style="float: left;margin-right: 5px;">
                                    <label class="line-height-1">
                                        <input name="type" id="type" checked  value="0" type="radio" class="ace">
                                ...
                                <input type="text" style="display: none;" id="txtType" value="0">
                            </div>
                        </div>
...
<script type="text/javascript">
    jQuery(function ($) {
        ...
        $("#validation-form .btn-success").on("click", function () {
            ...
            jQuery.ajax({
                type: "POST",
                data: {"classid":$("#classid").val(),"isSchool":$("#txtType").val(),"name":$("#name").val()},
                dataType: "text",
                url: "/manage/eclassbrand/news/doTypeAdd",
