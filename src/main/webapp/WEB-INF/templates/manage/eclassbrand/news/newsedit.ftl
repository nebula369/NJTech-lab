                    ...
                    <form class="form-horizontal" id="validation-form" role="form">
                        <table style="width:100%">
                            <tr>
                                    ...
                                    <div class="form-group" id="stage">
                                        ...
                                        <div class="col-sm-9" style="float: left; margin-top: 5px;">
                                            <div class="clearfix" style="float:left;;width:200px">
                                                <input class="form-control" value="${news.title}" id="title" name="title" type="text">
                                            </div>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <div class="form-group" id="stage">
                                        ...
                                        <div class="col-sm-9" style="float: left; margin-top: 5px;">
                                            <div class="clearfix" style="float:left;;width:200px">
                                                <input class="form-control" value="${news.author}" id="author" name="author" type="text">
                                            </div>
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <div class="form-group" id="stage">
                                        <label class="control-label col-sm-3 no-padding-right text-right" style="float:left;padding-top: 5px;width: 100px;" for="stage">新闻介绍:</label>
                                        <div class="col-sm-9" style="float: left; margin-top: 5px;">
                                            <div class="clearfix" style="float:left;;width:200px">
                                                <input class="form-control" value="${news.intro}" id="intro" name="intro" type="text">
                                            </div>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <div class="form-group" id="stage">
                                        ...
                                        <div class="col-sm-9" style="float: left; margin-top: 5px;">
                                            <div class="clearfix" style="float:left;width:200px">
                                                <input class="form-control" value="${news.sortnum}" id="sortnum" name="sortnum" type="text">
                                            </div>
                                        </div>
                                    </div>
                                </td>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9" style="float: left; margin-top: 5px;">
                                            <div class="clearfix" style="float:left;">
                                                <img src="/${news.photo}"  id="pictureimg" alt="图片"  height="60px"  onerror="javascript:this.src='/assets/lib/images/default/defaultpicture.png';"/>
                                                <input type="file" id="file" name="file"  />
                                                <input type="hidden" id="picture" value="/${news.photo}" name="picture" />
                                            </div>
                                        </div>
                                    </div>
                                </td>
                        ...
                        <div class="form-group" id="stage">
                            <label class="control-label col-sm-3 no-padding-right text-right" style="float:left;padding-top: 5px;width: 100px;" for="stage">活动详情:</label>
                            <div class="col-sm-9" style="float: left; margin-top: 5px;">
                                <div class="clearfix" style="float:left;">
                                    <textarea id="container" style="min-height:350px" name="container">${news.content}</textarea>
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    jQuery(function ($) {
        ...
        $("#validation-form .btn-success").on("click", function () {
            ...
            jQuery.ajax({
                type: "POST",
                data: {"pkid":${news.pkid},"newsType":${newstypeid},"intro":$("#intro").val(),"title":$("#title").val(),"author":$("#author").val(),"sortnum":$("#sortnum").val(),"content":ue.getContent(),"photo":$("#picture").val()},
                dataType: "text",
                url: "/manage/eclassbrand/news/doEdit",
    ...
    UE.Editor.prototype.getActionUrl = function(action) {
        if (action == 'uploadimage' || action == 'uploadscrawl' || action == 'listimage') {
            return '/manage/basic/ueditorUpload';
        } else {
