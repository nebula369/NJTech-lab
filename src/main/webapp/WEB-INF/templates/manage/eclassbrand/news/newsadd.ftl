                ...
                <div class="col-xs-12">
                    <form class="form-horizontal" id="validation-form" role="form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9" style="float: left; margin-top: 5px;">
                                            <div class="clearfix" style="float:left;">
                                                <img src=""  id="pictureimg" alt="图片"  height="60px"  onerror="javascript:this.src='/assets/lib/images/default/defaultpicture.png';"/>
                        ...
                        <div class="form-group" id="stage">
                            ...
                            <div class="col-sm-9" style="float: left; margin-top: 5px;">
                                <div class="clearfix" style="float:left;">
                                    <textarea id="container" style="min-height:350px" name="container"></textarea>
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript">
    jQuery(function ($) {
        ...
        $("#validation-form .btn-success").on("click", function () {
            ...
            jQuery.ajax({
                type: "POST",
                data: {"newsType":${newstypeid},"intro":$("#intro").val(),"title":$("#title").val(),"author":$("#author").val(),"sortnum":$("#sortnum").val(),"content":ue.getContent(),"photo":$("#picture").val()},
                dataType: "text",
                url: "/manage/eclassbrand/news/doAdd",
