            ...
            <div class="row">
                <div class="col-xs-12">
                    <form class="form-horizontal" id="validation-form" role="form">
                        ...
                        <div class="form-group">
                            <label class="control-label col-sm-3 no-padding-right text-right" style="float:left;padding-top: 0px;width: 100px;" for="name">选择学生照片压缩包:</label>
                            <div class="col-sm-9" style="float: left;">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9" style="float: left;">
                                <a href="/assets/static/StudentPhoto.zip">学生照片压缩包示例下载</a>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    function doInport(fileName)
    {
        ...
        jQuery.ajax({
            ...
            dataType: "text",
            url: "/manage/basic/student/doInportPhoto",
            success: function (result) {
                if(result == "1")
                {
                    layer.alert("导入学生照片成功", {icon: 6},function () {
                        // 获得frame索引
