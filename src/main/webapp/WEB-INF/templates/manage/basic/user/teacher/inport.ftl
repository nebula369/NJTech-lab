                ...
                <div class="col-xs-12">
                    <form class="form-horizontal" id="validation-form" role="form">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9" style="float: left;">
                                <div class="clearfix" style="float:left;">
                                    <select class="chosen-select form-control" name="unitId" id="unitId" data-placeholder="--请选择所属单位--">
                                        <option value=""></option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9" style="float: left;">
                               <a href="/assets/static/Template_Teacher.xls">教职工模板下载</a>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    function doInport(fileName)
    {
        ...
        jQuery.ajax({
            ...
            dataType: "text",
            url: "/manage/basic/teacher/doInport",
            success: function (result) {
                if(result == "1")
                {
                    layer.alert("导入教职工数据成功", {icon: 6},function () {
                        // 获得frame索引
