                        ...
                        <table width="100%">
                                ...
                                <td rowspan="3">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9" style="float: left; margin-top: 5px;">
                                            <div class="clearfix" style="float:left;">
                                                <img src=""  id="headimg" alt="头像" width="80px" height="80px"   onerror="javascript:this.src='/assets/lib/images/avatars/avatar2.png';">
                            ...
                            <tr>
                                <td>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9" style="float: left; margin-top: 5px;">
                                            <div class="clearfix" style="float:left;">
                                                <input class="form-control" value="" id="loginName" name="loginName" type="text"  style="width: 300px;" >
                                            </div>
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td>  <div class="form-group">
                                        ...
                                        <div class="col-sm-9" style="float: left; margin-top: 5px;">
                                            <div class="clearfix" style="float:left;">
                                                <input class="form-control" value="" id="name" name="name" type="text"  style="width: 300px;" >
                                            </div>
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <div class="form-group">
                                        <label class="control-label col-sm-3 no-padding-right text-right" style="float:left;padding-top: 10px;width: 100px;" for="password">密码:</label>
                                        <div class="col-sm-9" style="float: left; margin-top: 5px;">
                                            <div class="clearfix" style="float:left;">
                                                <input class="form-control" value="" id="password" name="password" type="password" style="width: 300px;" >
                                            </div>
                                        </div>
                                    </div>
                                  </td>
                                <td>
                                    <div class="form-group" id="stage">
                                        ...
                                        <div class="col-sm-9" style="float: left; margin-top: 5px;">
                                            <div class="clearfix" style="float:left;">
                                                <select class="chosen-select form-control" name="sex" id="sex" style="width: 300px;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9" style="float: left; margin-top: 5px;">
                                            <div class="clearfix" style="float:left;">
                                                <input class="form-control" value="" id="mobile" name="mobile" type="text"  style="width: 300px;" >
                                            </div>
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr >
                                <td>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9" style="float: left; margin-top: 5px;">
                                            <div class="clearfix" style="float:left;">
                                                <input class="form-control" value="" id="email" name="email" type="text"  style="width: 300px;" >
                                            </div>
                                        </div>
                                    </div>
                                </td>
                                <td >
                                    <div class="form-group" id="stage">
                                        ...
                                        <div class="col-sm-9" style="float: left; margin-top: 5px;">
                                            <div class="clearfix" style="float:left;">
                                                <textarea class="form-control" value="" id="profile" name="profile" cols="40" rows="4" style="overflow: hidden; margin: 0px; width: 300px; height: 95px;resize: none;"></textarea>
                                            </div>
                                        </div>
                                    </div>
...
<script type="text/javascript">
    jQuery(function ($) {
        ...
        $("#validation-form .btn-success").on("click", function () {
            ...
            jQuery.ajax({
                type: "POST",
                data: {"name":$("#name").val(),"loginname":$("#loginName").val(),"password":$("#password").val(),"mobile":$("#mobile").val(),"email":$("#email").val(),"sex":$("#sex").val(),"photo":$("#photo").val(),"profile":$("#profile").val(),"unitId":$("#unitId").val(),"deptIds":""+$("#dept").val()+"","gradeIds":""+$("#grade").val()+"","subjectIds":""+$("#subject").val()+""},
                dataType: "text",
                url: "/manage/basic/teacher/doAdd",
                success: function (result) {
                    ...
                    {
                        layer.msg("当前帐号已经存在，不能重复",{icon:2});
