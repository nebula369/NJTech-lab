...
<div class="main-container ace-save-state" id="main-container">
    ...
    <!-- 加载左侧菜单 -->
    <@leftMenu indexUrl="/manage/basic/index" menuList=menuConfig.menuList currentUrl="/manage/basic/teacher"/>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-9 no-padding-left">
                                            <div style="margin-bottom: 5px;">
                                                <button id="btnAdd" style="float:left; margin-top: 2px" class="btn btn-success btn-mini radius-4"><i class="ace-icon fa fa-plus"></i>新增教职工</button>
...
<script type="text/javascript">
    ...
    jQuery(function ($) {
        ...
        $("#btnAdd").on("click", function () {
            layer_show("新建教职工", "/manage/basic/teacher/add", 950,580);
            event.stopPropagation();
        });

        $("#btnInport").on("click", function () {
            layer_show("教职工数据导入", "/manage/basic/teacher/inport", 500, 250);
            event.stopPropagation();
        });
        ...
        $("#btnDel").on("click", function () {
            layer.confirm("确定删除选中的教职工数据?", function (index) {
                layer.close(index);
    ...
    function modify(id)
    {
        layer_show("编辑教职工数据", "/manage/basic/teacher/edit?id=" + id, 950, 580);
        event.stopPropagation();
    }
    ...
    {
        layer.confirm("确定删除教职工“"+name+"”？", function (index) {
            layer.close(index);
            jQuery.ajax({
                type: "POST",
                data: {"id":id},
