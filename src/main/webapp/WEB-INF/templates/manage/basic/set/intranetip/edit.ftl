                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9" style="float: left;">
                                <div class="clearfix" style="float:left;">
                                    <input type="text" name="ipstart" value="${data.ipstartstr}" id="ipstart" style="width: 200px;" class="col-xs-12 col-sm-6">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-9" style="float: left;">
                                <div class="clearfix" style="float:left;">
                                    <input type="text" name="ipend" value="${data.ipendstr}" id="ipend" style="width: 200px;" class="col-xs-12 col-sm-6">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-9" style="float: left;">
                                <div class="clearfix" style="float:left;">
                                    <textarea class="form-control limited" style="width: 350px;height: 80px;" placeholder="最多输入50个字符" id="remark" maxlength="50">${data.remark}</textarea>
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript">
    jQuery(function ($) {
        ...
        $("#validation-form .btn-success").on("click", function () {
            ...
            jQuery.ajax({
                type: "POST",
                data: {"pkid":${data.pkid},"ipstartstr":$("#ipstart").val(),"ipendstr":$("#ipend").val(),"remark":$("#remark").val()},
                dataType: "text",
                url: "/manage/basic/intranetIp/doEdit",
