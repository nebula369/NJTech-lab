                ...
                <div class="col-xs-12">
                    <form class="form-horizontal" id="validation-form" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9" style="float: left;">
                                <div class="clearfix" style="float:left;">
                                    <input type="text" name="appUrl" value="" id="appUrl" style="width: 300px;" class="col-xs-12 col-sm-6">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-9" style="float: left;">
                                <div class="clearfix" style="float:left;">
                                    <input type="text" name="appKey" value="" id="appKey" class="col-xs-12 col-sm-6">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
...
<script type="text/javascript">
    jQuery(function ($) {
        ...
        $("#validation-form .btn-success").on("click", function () {
            ...
            jQuery.ajax({
                type: "POST",
                data: {"name":$("#name").val(),"appurl":$("#appUrl").val(),"linktarget":linktarget,"icon":$("#icon").val(),
                "status":status,"appkey":$("#appKey").val()},
                dataType: "text",
                url: "/manage/basic/thirdApp/doAdd",
