            ...
            <div class="row">
                <div class="col-xs-12">
                    <form class="form-horizontal" id="validation-form" role="form">
                        ...
                        <div class="form-group">
                            <label class="control-label col-sm-3 no-padding-right text-right" style="float:left;width: 100px;" for="name">所属菜单:</label>
                            <div class="col-sm-9" style="float: left;">
                                <div class="clearfix" style="float:left;">
                        ...
                        <div class="form-group">
                            <label class="control-label col-sm-3 no-padding-right text-right" style="float:left;padding-top: 5px;width: 100px;" for="name">子菜单名称:</label>
                            <div class="col-sm-9" style="float: left;">
                                <div class="clearfix" style="float:left;">
                        ...
                        <div class="form-group">
                            <label class="control-label col-sm-3 no-padding-right text-right" style="float:left;padding-top: 5px;width: 100px;" for="link">菜单URL:</label>
                            <div class="col-sm-9" style="float: left;">
                                <div class="clearfix" style="float:left;">
                                    <input type="text" name="link" value="${menu.link}" id="link" style="width: 300px;" class="col-xs-12 col-sm-6">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-9" style="float:left;width: 200px;">
                                <div style="float: left;">
                                    <label class="line-height-1">
                                        <input name="linktarget" <#if menu.linktarget==0>checked</#if> value="0" type="radio" class="ace">
                                        <span class="lbl">当前窗口</span>
                                    </label>
                                </div>
                                <div style="float:left;">
                                    <label class="line-height-1">
                                        <input name="linktarget" <#if menu.linktarget==1>checked</#if> value="1" type="radio" class="ace">
...
<script type="text/javascript">
    jQuery(function ($) {
        ...
        $("#validation-form .btn-success").on("click", function () {
            ...
            jQuery.ajax({
                type: "POST",
                data: {"name":$("#name").val(),"link":$("#link").val(),"linktarget":linktarget,
                "status":status,"pkid":${menu.pkid},"usetype":usetype},
                dataType: "text",
                url: "/manage/basic/app/doSubMenuEdit",
                success: function (result) {
                    if(result == 1) {
                        layer.msg("保存成功", {icon: 1, time: 1000}, function () {
                            parent.initAppSubMenuList();
                            layer_close();
                        });
                    }
                    else if(result == 0)
                    {
                        layer.msg("关联的菜单信息不存在",{icon:2});
