...
<div class="main-container ace-save-state" id="main-container">
    ...
    <!-- 加载左侧菜单 -->
    <@leftMenu indexUrl="/manage/basic/index" menuList=menuConfig.menuList currentUrl="/manage/basic/loginLog"/>
                ...
                <div class="row">
                    <div class="col-xs-12" style="padding:0px;">
                        <div style="margin-bottom: 5px;">
                            ...
                            <label style="padding-top: 3px;" class="col-sm-1 no-padding-right" for="txtUserName">登录用户</label>
                            <input type="text" id="txtUserName" placeholder="请输入登录用户名" class="input-sm" />
...
<script type="text/javascript">
    jQuery(function ($) {
        ...
        $("#grid-table").jqGrid({
            url: "/manage/basic/getLoginLogPageList",
            datatype: "json", // 从服务器端返回的数据类型，默认xml。可选类型：xml，local，json，jsonnp，script，xmlstring，jsonstring，clientside
            mtype: "POST", // 提交方式，默认为GET
            height: "auto", // 高度，表格高度。可为数值、百分比或'auto'
            colNames: ['登录用户', '登录IP', '登录模块', '详细描述', '操作时间'], // 列显示名称，是一个数组对象
            colModel: [
                // name 表示列显示的名称；
                ...
                {name: 'loginip', index: 'loginip', width: 120, fixed:true, align: 'left',sortable:true, resize:false},
                {name: 'loginmodule', index: 'loginmodule', width: 120, fixed:true, align: 'left',sortable:true, resize:false},
