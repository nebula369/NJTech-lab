                ...
                <div class="col-xs-12">
                    <form class="form-horizontal" id="validation-form" role="form">
                                ...
                                <div class="clearfix" style="float:left;">
                                    <select class="chosen-select form-control" disabled name="unitId" id="unitId" style="width: 200px;" data-placeholder="--请选择所属单位--">
                                        ...
                                        <#list unitList as item>
                                            <option value="${item.pkid}" <#if item.pkid == dept.unitid>selected</#if>>${item.name}</option>
                                        </#list>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="form-group" id="stage">
                            <label class="control-label col-sm-3 no-padding-right text-right" style="float:left;padding-top: 5px;width: 100px;" for="stage">部门名称:</label>
                            <div class="col-sm-9" style="float: left; margin-top: 5px;">
                                <div class="clearfix" style="float:left;">
                                    <input class="form-control" value="${dept.name}" id="name" name="name" type="text">
                                </div>
                            </div>
                        </div>
                        <div class="form-group" id="stage">
                            ...
                            <div class="col-sm-9" style="float: left; margin-top: 5px;">
                                <div class="clearfix" style="float:left;">
                                    <input class="form-control" value="${dept.sortnum}" id="sortnum" name="sortnum" type="text">
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript">
    jQuery(function ($) {
        ...
        $("#validation-form .btn-success").on("click", function () {
            ...
            jQuery.ajax({
                type: "POST",
                data: {"pkid":${dept.pkid},"unitid":$("#unitId").val(),"name":$("#name").val(),"sortnum":$("#sortnum").val()},
                dataType: "text",
                url: "/manage/basic/dept/doEdit",
