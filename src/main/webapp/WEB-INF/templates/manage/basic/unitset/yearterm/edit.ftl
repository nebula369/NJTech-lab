                ...
                <div class="col-xs-12">
                    <form class="form-horizontal" id="validation-form" role="form">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9" style="float: left;">
                                <div class="clearfix" style="float:left;">
                                    <select class="chosen-select form-control" disabled name="schoolid" id="schoolid" style="width: 200px;" data-placeholder="--请选择所属学校--">
                                        <option value=""></option>
                                        <#list unitList as item>
                                            <option value="${item.pkid}" <#if item.pkid==yearTerm.schoolid>selected</#if>>${item.name}</option>
                                        </#list>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9" style="float: left;">
                                <div class="clearfix" style="float:left;">
                                    <select class="chosen-select form-control" disabled name="name" id="name" style="width: 200px;">
                                        <#list yearList as item>
                                            <option value="${item}" <#if item==yearTerm.name>selected</#if>>${item}</option>
                                        </#list>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9" style="float: left;">
                                <div class="clearfix" style="float:left;">
                                    <select class="chosen-select form-control" disabled name="schoolterm" id="schoolterm" style="width: 200px;">
                                        <#list termList as item>
                                            <option value="${item.code}" <#if item.code == yearTerm.schoolterm?string>selected</#if>>${item.name}</option>
                                        </#list>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="form-group" id="stage">
                            ...
                            <div class="col-sm-9" style="float: left; margin-top: 5px;">
                                <div class="clearfix input-group col-xs-2" style="float:left;width:300px">
                                        ...
                                        <input class="input-sm" style="width: 200px;" value="${yearTerm.workstartdate?string("yyyy-MM-dd") +"--" + yearTerm.workenddate?string("yyyy-MM-dd")}" type="text" name="date" id="workdate">
                                </div>
                            </div>
                        </div>
                        <div class="form-group" id="stage">
                            ...
                            <div class="col-sm-9" style="float: left; margin-top: 5px;">
                                <div class="clearfix input-group col-xs-2" style="float:left;width:300px">
                                    ...
                                    <input class="input-sm" style="width: 200px;" value="${yearTerm.learnstartdate?string("yyyy-MM-dd") +"--" + yearTerm.learnenddate?string("yyyy-MM-dd")}" type="text" name="date" id="learndate">
                                </div>
                            </div>
                        </div>
                        <div class="form-group" id="stage">
                            ...
                            <div class="col-sm-9" style="float: left; margin-top: 5px;">
                                <div class="clearfix" style="float:left;">
                                    <input class="form-control" value="${yearTerm.morningsessions}" id="morningsessions" name="sessions" type="text">
                                </div>
                            </div>
                        </div>
                        <div class="form-group" id="stage">
                            ...
                            <div class="col-sm-9" style="float: left; margin-top: 5px;">
                                <div class="clearfix" style="float:left;">
                                    <input class="form-control" value="${yearTerm.afternoonsessions}" id="aftersessions" name="sessions" type="text">
                                </div>
                            </div>
                        </div>
                        <div class="form-group" id="stage">
                            ...
                            <div class="col-sm-9" style="float: left; margin-top: 5px;">
                                <div class="clearfix" style="float:left;">
                                    <input class="form-control" value="${yearTerm.eveningsessions}" id="eveningsessions" name="sessions" type="text">
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript">
    jQuery(function ($) {
        ...
        $("#validation-form .btn-success").on("click", function () {
            ...
            jQuery.ajax({
                type: "POST",
                data: {"pkid":${yearTerm.pkid},"schoolid":$("#schoolid").val(),"name":$("#name").val(),"schoolterm":$("#schoolterm").val(),"workstartdate": workStartDate,"workenddate": workEndDate,"learnstartdate":learningStartDate, "learnenddate":learningEndDate, "morningsessions":$("#morningsessions").val(),"afternoonsessions":$("#aftersessions").val(),"eveningsessions":$("#eveningsessions").val()},
                dataType: "text",
                url: "/manage/basic/yearterm/doEdit",
