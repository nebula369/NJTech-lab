                ...
                <div class="col-xs-12">
                    <form class="form-horizontal" id="validation-form" role="form">
                        ...
                        <div class="form-group" id="stage">
                            ...
                            <div class="col-sm-9" style="float: left; margin-top: 5px;">
                                <div class="clearfix" style="float:left;">
                                    <input class="form-control" value="" style="width: 250px" id="address" name="address" type="text">
                                </div>
                            </div>
                        </div>
                        <div class="form-group" id="stage">
                            ...
                            <div class="col-sm-9" style="float: left; margin-top: 5px;">
                                <div class="clearfix" style="float:left;">
                                    <input class="form-control" value="" style="width: 100px" id="capacity" name="capacity" type="text">
                                </div>
                            </div>
                        </div>
                        <div class="form-group" id="stage">
...
<script type="text/javascript">
    jQuery(function ($) {
        ...
        $("#validation-form .btn-success").on("click", function () {
            ...
            jQuery.ajax({
                type: "POST",
                data: {"typeid":${typeId},"name":$("#name").val(),"address":$("#address").val(),"sortnum":$("#sortnum").val(),"capacity":$("#capacity").val(),"remark":$("#remark").val()},
                dataType: "text",
                url: "/manage/basic/space/spaceDoAdd",
