                                ...
                                <#list unitType as item>
                                    <div style="float: left;margin-right: 5px;">
                                        <label class="line-height-1">
                                            <input name="type" <#if item_index==0>checked</#if> value="${item.code}" type="radio" class="ace">
                            ...
                            <div class="col-sm-9" style="float: left; margin-top: 5px;">
                                <div class="clearfix" style="float:left;">
                                    <#list stageList as item>
                                         <div style="float: left;margin-right: 5px;">
                                             <label class="line-height-1">
                                                 <input name="stageid" value="${item.code}" type="checkbox" class="ace ace-checkbox-2">
                                                 <span class="lbl">${item.name}</span>
                                             </label>
                                         </div>
                                    </#list>
...
<script type="text/javascript">
    jQuery(function ($) {
        ...
        $("#validation-form .btn-success").on("click", function () {
            ...
            jQuery.ajax({
                type: "POST",
                data: {"name":$("#name").val(),"parentid":$("#parentid").val(),"type":type,"stageids":stageIds,"manageuser":$("#manageuser").val()},
                dataType: "text",
                url: "/manage/basic/unit/doAdd",
        ...
        function initStage()
        {
            ...
            if(type == 1)
            {
                $("input:checkbox[name=stageid]").prop("checked", "");
                $("#stage").show();
            }
            else {
                $("#stage").hide();
