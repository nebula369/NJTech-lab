                    ...
                    <form class="form-horizontal" id="validation-form" role="form">
                                ...
                                <div class="clearfix" style="float:left;">
                                    <select class="chosen-select form-control" disabled name="unitId" id="unitId" style="width: 200px;" data-placeholder="--请选择所属单位--">
                                        ...
                                        <#list unitList as item>
                                            <option value="${item.pkid}" <#if item.pkid == spaceType.unitid>selected</#if>>${item.name}</option>
                                        </#list>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="form-group" id="stage">
                            ...
                            <div class="col-sm-9" style="float: left; margin-top: 5px;">
                                <div class="clearfix" style="float:left;">
                                    <input class="form-control" value="${spaceType.name}" style="width: 250px;" id="name" name="name" type="text">
                                </div>
                            </div>
                        </div>
                        <div class="form-group" id="stage">
                            ...
                            <div class="col-sm-9" style="float: left; margin-top: 5px;">
                                <div class="clearfix" style="float:left;">
                                    <input class="form-control" value="${spaceType.sortnum}" style="width: 100px;" id="sortnum" name="sortnum" type="text">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-9" style="float: left;">
                                <div class="clearfix" style="float:left;">
                                    <textarea class="form-control limited" style="width: 350px;height: 80px;" placeholder="最多输入50个字符" id="remark" maxlength="50">${spaceType.remark}</textarea>
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript">
    jQuery(function ($) {
        ...
        $("#validation-form .btn-success").on("click", function () {
            ...
            jQuery.ajax({
                type: "POST",
                data: {"pkid":${spaceType.pkid},"name":$("#name").val(),"sortnum":$("#sortnum").val(),"remark":$("#remark").val()},
                dataType: "text",
                url: "/manage/basic/space/doEdit",
