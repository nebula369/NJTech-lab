                ...
                <div class="col-xs-12">
                    <form class="form-horizontal" id="validation-form" role="form">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9" style="float: left;">
                                <div class="clearfix" style="float:left;">
                                    <select class="chosen-select form-control" disabled name="schoolId" id="schoolId" style="width: 200px;" data-placeholder="--请选择学校--">
                                        <option value=""></option>
                                        <#list unitList as item>
                                            <option value="${item.pkid}" <#if item.pkid == schoolClass.unitid>selected</#if>>${item.name}</option>
                                        </#list>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9" style="float: left;">
                                <div class="clearfix" style="float:left;">
                                    <select class="chosen-select form-control" disabled name="stage" style="width: 150px" id="stage" data-placeholder="--请选择学段--">
                                        <option value=""></option>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9" style="float: left;">
                                <div class="clearfix" style="float:left;">
                                    <select class="chosen-select form-control" disabled style="width: 150px;" name="grade" id="grade" data-placeholder="--请选择年级--">
                                        <option value=""></option>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="form-group" id="stage">
                            ...
                            <div class="col-sm-9" style="float: left; margin-top: 5px;">
                                <div class="clearfix" style="float:left;">
                                    <input class="form-control" disabled value="${schoolClass.classcode}" id="classCode" name="classCode" type="text">
                                </div>
                            </div>
                        </div>
                        <div class="form-group" id="stage">
                            ...
                            <div class="col-sm-9" style="float: left; margin-top: 5px;">
                                ...
                                <div class="clearfix" style="float:left;">
                                    <input class="form-control" disabled value="${schoolClass.name}" id="name" name="name" type="text">
                                </div>
                            </div>
                        </div>
                        <div class="form-group" id="stage">
                            ...
                            <div class="col-sm-9" style="float: left; margin-top: 5px;">
                                <div class="clearfix" style="float:left;">
                                    <input class="form-control" value="${schoolClass.schoolsystem}" style="width:100px;" id="schoolYear" name="schoolYear" type="text">
                                </div>
                            </div>
                        </div>
                        <div class="form-group" id="stage">
                                ...
                                <div class="clearfix" style="float:left;">
                                    <select class="chosen-select form-control" name="spaceType" id="spaceType" style="float:left;" data-placeholder="--请选择场地--">
                                        ...
                                        <#list spaceTypes as item>
                                            <option value="${item.pkid}" <#if item.pkid?string==typeId?string>selected</#if>>${item.name}</option>
                                        </#list>
                                    </select>
                        ...
                        <div class="form-group" id="stage">
                            ...
                            <div class="col-sm-9" style="float: left; margin-top: 5px;">
                                <div class="clearfix" style="float:left;">
                                    <input class="form-control" style="width: 100px" value="${schoolClass.sortnum}" id="sortnum" name="sortnum" type="text">
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript">
    jQuery(function ($) {
        ...
        $("#validation-form .btn-success").on("click", function () {
            ...
            jQuery.ajax({
                type: "POST",
                data: {"pkid":${schoolClass.pkid},"unitid":$("#schoolId").val(),"name":$("#name").val(),"sortnum":$("#sortnum").val(),
            ...
            jQuery.ajax({
                ...
                success: function (result) {
                    ...
                    for(var i=0;i<result.length;i++){
                        if(result[i].code == "${schoolClass.stageid}")
                        {
                            html += '<option value="' + result[i].code + '" selected>' + result[i].name + '</option>';
                        }
                        else {
        ...
        function initGrade()
        {
            ...
            jQuery.ajax({
                ...
                success: function (result) {
                    var html = '';
                    for(var i=0;i<result.length;i++){
                        if(result[i].code == "${schoolClass.gradeid}")
                        {
                            html += '<option value="' + result[i].code + '" selected>' + result[i].name + '</option>';
                        }
                        else {
