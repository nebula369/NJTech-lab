...
<div class="main-container ace-save-state" id="main-container">
    ...
    <!-- 加载左侧菜单 -->
    <@leftMenu indexUrl="/manage/basic/index" menuList=menuConfig.menuList currentUrl="/manage/basic/index"/>
                        ...
                        <div class="hide message-content" id="id-message-content">
                            <div class="message-header clearfix">
                                <div class="pull-left">
                                    ...
                                    &nbsp;
                                    <img class="middle" alt="John's Avatar" src="/assets/lib/images/avatars/avatar.png" width="32" />
                                    &nbsp;
                            ...
                            <div class="message-attachment clearfix">
                                ...
                                <div class="attachment-images pull-right">
                                    ...
                                    <div>
                                        <img width="36" alt="image 4" src="/assets/lib/images/gallery/thumb-4.jpg" />
                                        <img width="36" alt="image 3" src="/assets/lib/images/gallery/thumb-3.jpg" />
                                        <img width="36" alt="image 2" src="/assets/lib/images/gallery/thumb-2.jpg" />
                                        <img width="36" alt="image 1" src="/assets/lib/images/gallery/thumb-1.jpg" />
                                    </div>
                                </div>
                            </div>
                        </div><!-- /.message-content -->
