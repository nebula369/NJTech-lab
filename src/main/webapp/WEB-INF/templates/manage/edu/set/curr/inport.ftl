                ...
                <div class="col-xs-12">
                    <form class="form-horizontal" id="validation-form" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9" style="float: left;">
                               <a href="/assets/static/CourseTemplate.xls">课表模板下载</a>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    function doInport(fileName)
    {
        ...
        jQuery.ajax({
            type: "POST",
            data: {"fileName":fileName, "schoolId": ${schoolId},"classId":${classId}},
            dataType: "text",
            url: "/manage/edu/curriculum/doInportTemplate",
            success: function (result) {
                if(result == "1")
                {
                    layer.alert("导入学校班级课程表成功", {icon: 6},function () {
                        // 获得frame索引
