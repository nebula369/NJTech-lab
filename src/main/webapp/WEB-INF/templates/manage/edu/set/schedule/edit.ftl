                    ...
                    <form class="form-horizontal" id="validation-form" role="form">
                            ...
                            <div class="col-sm-9" style="float: left;">
                                <div class="clearfix" style="float:left;">
                                    <select class="chosen-select form-control" disabled name="name" id="name" style="width: 200px;">
                                        <#list list as item>
                                            <option value="${item.code}" <#if schedule.session?string == item.code>selected</#if> >${item.name}</option>
                                        </#list>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="clearfix" style="float:left;">
                                    <select class="chosen-select form-control" name="type" id="type" style="width: 200px;">
                                        <#list sksxList as item>
                                            <option value="${item.code}" <#if schedule.type?string == item.code>selected</#if> >${item.name}</option>
                                        </#list>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="clearfix" style="float:left;">
                                    <select class="chosen-select form-control" name="time" id="time" style="width: 200px;">
                                        <#list sksdList as item>
                                            <option value="${item.code}" <#if schedule.time?string == item.code>selected</#if> >${item.name}</option>
                                        </#list>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="form-group" id="stage">
                            ...
                            <div class="col-sm-9" style="float: left; margin-top: 5px;">
                                <div class="clearfix" style="float:left;">
                                    <input class="form-control" value="${schedule.startTime}" id="starttime" name="starttime" type="text">
                                </div>
                            </div>
                        </div>
                        <div class="form-group" id="stage">
                            ...
                            <div class="col-sm-9" style="float: left; margin-top: 5px;">
                                <div class="clearfix" style="float:left;">
                                    <input class="form-control" value="${schedule.endTime}" id="endtime" name="endtime" type="text">
                                </div>
                            </div>
                        </div>
                        <div class="form-group" id="stage">
                            ...
                            <div class="col-sm-9" style="float: left; margin-top: 5px;">
                                <div class="clearfix" style="float:left;">
                                    <#list xqList as item>
                                        <label>
                                        <input name="week" type="checkbox" data-week="${item.code}" <#if weeks?split(",")?seq_contains(item.code)>checked</#if> class="ace ace-checkbox-2">
                        ...
                        <div class="form-group" id="stage">
                            ...
                            <div class="col-sm-9" style="float: left; margin-top: 5px;">
                                <div class="clearfix" style="float:left;">
                                    <input class="form-control" value="${schedule.sortnum}" id="sortnum" name="sortnum" type="text">
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript">
    jQuery(function ($) {
        ...
        $("#validation-form .btn-success").on("click", function () {
            ...
            jQuery.ajax({
                type: "POST",
                data: {"pkid":${schedule.pkid},"type":$("#type").val(),"time":$("#time").val(),"sortnum":$("#sortnum").val(),"starttime":$("#starttime").val(),
                "endtime":$("#endtime").val(),"weeks": weeks.join(",")},
                dataType: "text",
                url: "/manage/edu/schedule/doEdit",
                success: function (result) {
                    ...
                    {
                        layer.msg("要编辑的上课时间段数据不存在",{icon:2});
                        obj.removeClass("disabled");
                    }
