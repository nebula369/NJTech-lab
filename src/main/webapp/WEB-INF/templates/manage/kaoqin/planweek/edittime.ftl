                        ...
                        <div class="form-group" id="stage">
                            ...
                            <div class="col-sm-9" style="float: left; margin-top: 5px;">
                                <div class="clearfix" style="float:left;">
                                    <input class="form-control" value="${startTime}" id="starttime" name="starttime" type="text">
                                </div>
                            </div>
                        </div>
                        <div class="form-group" id="stage">
                            ...
                            <div class="col-sm-9" style="float: left; margin-top: 5px;">
                                <div class="clearfix" style="float:left;">
                                    <input class="form-control" value="${endTime}" id="endtime" name="endtime" type="text">
                                </div>
                            </div>
                        </div>
                        <div class="form-group" id="stage">
    ...
    jQuery(function ($) {
        ...
        $("#validation-form .btn-success").on("click", function () {
            ...
            jQuery.ajax({
                ...
                dataType: "text",
                url: "/manage/kaoqin/planweek/doEditTime",
        ...
        $("#validation-form .btn-danger").on("click", function () {
            ...
            jQuery.ajax({
                ...
                dataType: "text",
                url: "/manage/kaoqin/planweek/doDelTime",
                success: function (result) {
                    if(result == 1) {
