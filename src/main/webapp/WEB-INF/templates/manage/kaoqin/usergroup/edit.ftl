                        ...
                        <div class="form-group" id="stage">
                            ...
                            <div class="col-sm-9" style="float: left; margin-top: 5px;">
                                <div class="clearfix" style="float:left;">
                                    <input class="form-control" value="${usergroup.groupname}" id="groupname" name="groupname" type="text">
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript">
    jQuery(function ($) {
        ...
        $("#validation-form .btn-success").on("click", function () {
            ...
            jQuery.ajax({
                type: "POST",
                data: {"pkid":${usergroup.pkid},"groupname":$("#groupname").val()},
                dataType: "text",
                url: "/manage/kaoqin/usergroup/doEdit",
