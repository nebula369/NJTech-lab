                    ...
                    <div class="col-xs-12" style="padding:0px;">
                        <form class="form-horizontal" id="validation-form" role="form">
                            <div class="form-group">
                                <label class="control-label col-sm-3 no-padding-right text-right" style="float:left;width: 100px;" for="parentid">所属单位:</label>
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-3 no-padding-right text-right" style="float:left;width: 100px;" for="dept">所属部门:</label>
                                <div class="col-sm-9" style="float: left; margin-top: 9px;">
                                    <div class="clearfix" style="float:left;">
                                        ${deptNames}
                                    </div>
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-3 no-padding-right text-right" style="float:left;width: 100px;" for="grade">所属年级:</label>
                                <div class="col-sm-9" style="float: left; margin-top: 9px;">
                                    <div class="clearfix" style="float:left;">
                                        ${gradeNames!""}
                                    </div>
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-3 no-padding-right text-right" style="float:left;width: 100px;" for="subject">所属学科:</label>
                                <div class="col-sm-9" style="float: left; margin-top: 9px;">
                                    <div class="clearfix" style="float:left;">
                                        ${subjectNames!""}
                                    </div>
